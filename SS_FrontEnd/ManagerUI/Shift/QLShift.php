...
<body style="display: flex; flex-direction:column">
    ...
    <div style="padding-left: 4%; width: 100%; padding-right: 4%">

        <div style="display: flex; padding-top: 1rem; padding-bottom: 1rem; justify-content: center; align-items: center; text-align: center;">
            <h2 style="font-size: 4rem; margin: 0; font-family: 'Poppins', sans-serif;">Quản lý ca làm</h2>
        </div>
        ...
        <div class="Admin_boxFeature__ECXnm">
            <div style="position: relative; width: 50%;">
                ...
                <input id="searchInput" class="Admin_input__LtEE-" style="width: 100%; font-family: 'Poppins', sans-serif; padding-left: 35px; padding-right: 10px; border-radius: 1rem;" placeholder="Bạn cần tìm kiếm ca làm nào?">
            </div>
