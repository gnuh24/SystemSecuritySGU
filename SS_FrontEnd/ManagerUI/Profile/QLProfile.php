...
<body>
    ...
    <div style="padding-left: 4%; width: 100%; padding-right: 5%">
        <div style="display: flex; padding-top: 1rem; padding-bottom: 1rem; justify-content: center; align-items: center; text-align: center;">
            <h2 style="font-size: 4rem; margin: 0;     font-family: Arial, sans-serif;
">Quản lý nhân sự</h2>
        </div>
        ...
        <div class="Admin_boxFeature__ECXnm">
            <div style="position: relative; width: 50%;">
                ...
                <input id="searchInput" class="Admin_input__LtEE-" style="width: 100%;     font-family: Arial, sans-serif;
 padding-left: 35px; padding-right: 10px; border-radius: 1rem;" placeholder="Bạn cần tìm kiếm nhân viên nào?">
            </div>
            
            <select id="selectQuyen" style="height: 3rem; padding: 0.3rem;     font-family: Arial, sans-serif;
 border-radius: 1rem;">
            ...
            <button id="addNV" style="height: 100%;     font-family: Arial, sans-serif;
 display: flex; align-items: center; background-color: #7FFF00; color: white; border: none; padding: 0.5rem 1rem; border-radius: 1rem; cursor: pointer; width">
                <i class="fa-solid fa-plus" style="margin-right: 5px; color: white;"></i>
                Thêm nhân viên
            </button>

            <button id="editNV" style="    font-family: Arial, sans-serif;
 display: flex; align-items: center; background-color: #B0C4DE; color: white; border: none; padding: 0.5rem 1rem; border-radius: 1rem; cursor: pointer;">
                <i class="fa-solid fa-edit" style="margin-right: 8px; color: white;"></i>
                Sửa
            </button>

            <button id="detailsNV" style="    font-family: Arial, sans-serif;
 display: flex; align-items: center; background-color: #FFA500; color: white; border: none; padding: 0.5rem 1rem; border-radius: 1rem; cursor: pointer;">
